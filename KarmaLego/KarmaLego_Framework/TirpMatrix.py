...
class TirpMatrix(object):
    ...
    def get_relation(self, first_index, second_index):
        """
            ...
            Constrains:
             ...
             use the function n(a1 + an)/2 to calcolate the offset in the relations array to be in the first place in
    ...
    def extend(self, relation_column):
        ...
        for index in range(1, len(relation_column) + 1):
            self._relations.insert(self._size * index, relation_column[index - 1]);
        self._size += 1;
